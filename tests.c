...
{   
    printf("\n\nTEST: test_ext_str()\n");
    char *dest = malloc(11); // Increase the size to 11
    char *s = malloc(12 * sizeof(char)); // Increase the size to 12
    s[0] ='\"';
    s[1] ='5';
    s[2] ='\\';
    s[3] ='n';
...
{
    printf("\n\nTEST: test_ext_int()\n");
    char *s = malloc(5); // Increase the size to 5
    s[0] ='2';
    s[1] ='_';
    s[2] ='1';
    s[3] ='_';
    s[4] ='\0'; // Add null-terminator

    // Hexadecimal cases
    char *t = malloc(6); // Increase the size to 6
    t[0] = '0';
    t[1] = 'x';
    t[2] = '0';
    t[3] = '9';
    t[4] = 'a';
    t[5] = '\0'; // Add null-terminator
...
void test_symtab() {
    ...
    SymbolTable st = populate_symboltables();
